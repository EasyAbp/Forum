...
using EasyAbp.Forum.Blazor.Server.Host.Menus;
...
namespace EasyAbp.Forum.Blazor.Server.Host
{
    [DependsOn(
        ...
        typeof(ForumBlazorServerModule)
    )]
    public class ForumBlazorHostModule: AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(ForumResource),
                    typeof(ForumDomainModule).Assembly,
                    typeof(ForumDomainSharedModule).Assembly,
                    typeof(ForumApplicationModule).Assembly,
                    typeof(ForumApplicationContractsModule).Assembly,
                    typeof(ForumBlazorHostModule).Assembly
                );
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/EasyAbp.Forum.Blazor.Server.Host.styles.css");
                    }
                );
            });
            ...
            if(hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<ForumBlazorHostModule>(hostingEnvironment.ContentRootPath);
                });
            }
            ...
            {
                options.AppAssembly = typeof(ForumBlazorHostModule).Assembly;
            });
        }
